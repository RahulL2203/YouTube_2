...
const commentsData= [
   {
      name:"Raavana_Simha",
      text:"Hey, It's Raavana Simha ....Commenting....",
      replies:[],
   },
   {
      name:"Raavana_Simha",
